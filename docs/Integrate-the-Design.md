...
Crearemos los siguientes componentes componentes:
...
Modificamos `_post-header.blade.php` para que la parte relacionada a categorias quede asi:
...
Y modificamos las siguiente rutas de la siguiente manera para que tengan un nombre:
